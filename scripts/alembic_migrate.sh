...
docker compose exec yt_assistant_api python3 -m alembic revision --autogenerate -m "$1"
...
echo ""
echo "================================================================ SQL CHANGES"
docker compose exec yt_assistant_api python3 -m alembic upgrade --sql head
